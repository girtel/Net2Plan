...
public class NetworkElement {
    ...
    public final void checkAttachedToNetPlanObject() {
        if (netPlan == null)
            throw new Net2PlanException("The element " + this + " is not associated to any NetPlan object");
    }
...
//	public final void checkAttachedToNetPlanObject (NetPlan np) { if (np != this.netPlan) throw new Net2PlanException ("The element " + this + " is not associated to the given NetPlan object");  }
    ...
    public final void checkAttachedToNetPlanObject(NetPlan np) {
        np.checkInThisNetPlan(this);
        if (np != this.netPlan)
            throw new Net2PlanException("The element " + this + " is not associated to the given NetPlan object");
    }
...
//			return (o instanceof NetworkElement) && (((NetworkElement)o).id == this.id) && (((NetworkElement)o).netPlan == this.netPlan); 
     ...
     * @since 0.4.0
     */
    final public NetPlan getNetPlan() {
        return netPlan;
    }
...
//	final public int hashCode() { return (int) id; }
     ...
     * @since 0.4.0
     */
    final public boolean wasRemoved() {
        return (netPlan == null);
    }
