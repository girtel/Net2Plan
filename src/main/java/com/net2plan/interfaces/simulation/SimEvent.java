...
public class SimEvent implements Comparable<SimEvent> {
    ...
    public enum DestinationModule {
        ...
        private DestinationModule(String label) {
            this.label = label;
        }
    ...
    public static class DemandAdd {
         ...
         */
        public DemandAdd
        (Node ingressNode, Node egressNode, NetworkLayer layer, double offeredTraffic) {
    ...
    public static class DemandRemove {
         ...
         */
        public DemandRemove(Demand demand) {
            this.demand = demand;
        }
    ...
    public static class RouteAdd {
        public Route routeAddedToFillByProcessor;
        public final Demand demand;
         ...
         */
        public RouteAdd(Demand demand, List<Link> seqLinks, double carriedTraffic, double occupiedLinkCapacity) {
            this.demand = demand;
            this.seqLinks = seqLinks == null ? new LinkedList<Link>() : new LinkedList<Link>(seqLinks);
            this
    ...
    public static class RouteRemove {
         ...
         */
        public RouteRemove(Route route) {
            this.route = route;
        }
    ...
    public static class RouteModify {
         ...
         */
        public RouteModify(Route route, List<Link> seqLinks, double carriedTraffic, double occupiedLinkCapacity) {
            this.route = route;
    ...
    public static class SegmentAdd {
         ...
         */
        public SegmentAdd(Set<Route> associatedRoutes, List<Link> seqLinks, double reservedLinkCapacity) {
            this.associatedRoutes = new HashSet<Route>(associatedRoutes);
            this.seqLinks = new
                    LinkedList<Link>(seqLinks);
            this.reservedLinkCapacity = reservedLinkCapacity;
        }
    ...
    public static class SegmentRemove {
         ...
         */
        public SegmentRemove(ProtectionSegment segment) {
    ...
    public static class NodesAndLinksChangeFailureState {
        public final Collection<Node> nodesToUp, nodesToDown;
        public final Collection<Link> linksToUp, linksToDown;
         ...
         */
        public NodesAndLinksChangeFailureState(Collection<Node> nodesToUp, Collection<Node> nodesToDown, Collection<Link> linksToUp, Collection<Link> linksToDown) {
            this.nodesToUp = nodesToUp
                    == null ? null : new HashSet<Node>(nodesToUp);
            this.nodesToDown = nodesToDown == null ? null : new HashSet<Node>(nodesToDown);
            this.linksToUp = linksToUp == null ? null : new HashSet<Link>(linksToUp);
            this.linksToDown = linksToDown == null ? null : new HashSet<Link>(linksToDown);
        }
    ...
    public static class LinkAdd {
         ...
         */
        public LinkAdd(Node originNode, Node destinationNode, NetworkLayer layer, double capacity, double lengthInKm, double propagationSpeedInKmPerSecond) {
    ...
    public static class LinkModify {
        public final Link link;
        public final double newCapacity;
         ...
         */
        public LinkModify(Link link, double newCapacity) {
            this.link = link;
