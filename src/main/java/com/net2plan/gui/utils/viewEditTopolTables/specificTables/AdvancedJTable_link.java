...
public class AdvancedJTable_link extends AdvancedJTable_NetworkElement
{
    ...
    public List<Object[]> getAllData(NetPlan currentState, NetPlan initialState, ArrayList<String> attributesColumns) 
    {
        ...
        for (Link link : currentState.getLinks()) {
            ...
            linkData[COLUMN_SHOWHIDE] = callback.getVisualizationState().isVisible(link);
                ...
                if (link.getCoupledDemand() != null) {
                    ...
                    decoupleLinkItem.addActionListener(new ActionListener() {
                        ...
                        public void actionPerformed(ActionEvent e) {
                        	...
                        	callback.updateVisualizationAfterChanges(Sets.newHashSet(NetworkElementType.LINK , NetworkElementType.DEMAND) , null , null);
                        }
                    });
