...
public class Offline_fa_xp11PathProtection implements IAlgorithm {
    ...
    public String executeAlgorithm(NetPlan netPlan, Map<String, String> algorithmParameters, Map<String, String> net2planParameters) {
        ...
        if (type11.getString().equalsIgnoreCase("srgDisjoint") && (netPlan.getNumberOfSRGs() == 0))
            throw new Net2PlanException("No SRG was defined");
        ...
        for (Demand d : netPlan.getDemands()) {
            ...
            for (Route r : d.getRoutes()) {
                if (xx_p[r.getIndex()] == 1) primary = r;
                if (bb_p[r.getIndex()] == 1) backup = r;
            }
