...
public abstract class IOFilter extends FileFilter implements Plugin {
     ...
     * @since 0.3.0
     */
    public boolean acceptAllExtensions() {
        return getAcceptedExtensions().isEmpty();
    }
    ...
    public Set<String> getAcceptedExtensions() {
        return Collections.unmodifiableSet(acceptedExtensions);
    }
     ...
     * @since 0.3.0
     */
    public final EnumSet<IOFeature> getFeatures() {
    ...
    public NetPlan readDemandSetFromFile(File file) {
        throw UNSUPPORTED_IO_OPERATION;
    }
