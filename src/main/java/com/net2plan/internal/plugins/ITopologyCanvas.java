...
public abstract class ITopologyCanvas implements Plugin {
    ...
    public final void showLink(Link link, Color color, boolean dashed) {
        final Map<Link, Pair<Color, Boolean>> map = new HashMap<Link, Pair<Color, Boolean>>();
        map.put(link, Pair.of(color, dashed));
    ...
    public final void showNode(Node node, Color color) {
        final Map<Node, Color> map = new HashMap<Node, Color>();
        map.put(node, color);
