...
public class Offline_ca_wirelessPersistenceProbabilityTest 
{
	private NetPlan np;
	...
	public void test() 
	{
		final IAlgorithm algorithm = new Offline_ca_wirelessPersistenceProbability();
		Map<String,List<String>> testingParameters = new HashMap<> ();
		testingParameters.put("simultaneousTxAndRxPossible" , Arrays.asList("true" , "false"));
	...
	{
		assertTrue (npOutput.getVectorLinkCapacity().zSum() > 0.1);
	}
