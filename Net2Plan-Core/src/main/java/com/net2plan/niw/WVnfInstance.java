...
{
	WVnfInstance(Resource r) { super (r, Optional.empty()); this.r = r; }
	...
	void checkConsistency()
	{
		...
		assert getTraversingServiceChains().stream().allMatch(s->s.getSequenceOfTraversedVnfInstances().contains(this));
