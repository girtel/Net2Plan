...
//    }
    ...
    public void doPopup(final MouseEvent e, final int row, final ElementSelection selection)
    {
        ...
        if (selection.getElementType() != NetworkElementType.MULTICAST_DEMAND) throw new RuntimeException("Unmatched items with table, selected items are of type: " + selection.getElementType());
