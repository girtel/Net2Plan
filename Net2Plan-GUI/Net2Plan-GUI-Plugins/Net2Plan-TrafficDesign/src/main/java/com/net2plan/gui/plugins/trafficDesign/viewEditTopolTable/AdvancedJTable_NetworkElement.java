...
package com.net2plan.gui.plugins.trafficDesign.viewEditTopolTable;
...
public abstract class AdvancedJTable_NetworkElement extends AdvancedJTable
{
    ...
    protected final GUITrafficDesign callback;
     ...
     * @since 0.2.0
     */
    public AdvancedJTable_NetworkElement(TableModel model, final GUITrafficDesign networkViewer, NetworkElementType networkElementType, boolean canExpandAttributes)
    {
        super(model);
        this.model = model;
