...
import com.net2plan.assembly.utils.Wget;
import com.net2plan.assembly.utils.Wget.WgetStatus;

public class DependenciesCutAndPastes 
{
	private final static Map<File , List<File>> cache_dependenciesFromPom = new HashMap<> ();	
	public static List<File> getExternalDependencies_n2pCore ()  { return getDependenciesOfMavenModuleAllFilesExistOrError(AssemblerMain.pomFile_n2pCore);  }

	public static List<File> getExternalDependencies_n2pGui () 
	{ 
		final List<File> depsIncludingN2pCore = getDependenciesOfMavenModuleAllFilesExistOrError(AssemblerMain.pomFile_n2pCore);
		final List<File> depsIncludingN2pGui = getDependenciesOfMavenModuleAllFilesExistOrError(AssemblerMain.pomFile_n2pGui);
